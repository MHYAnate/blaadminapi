...
// import {  generateVerificationCode, hashPassword } from '../utils.js';
// import bcrypt from 'bcrypt';
// import jwt from 'jsonwebtoken'
// import prisma from '../prismaClient.js';
// import { sendVerificationEmail, sendWelcomeEmail } from '../mailer.js';
...
//     let defaultRoleName;
//     if (type === 'business') {
//       defaultRoleName = 'business_owner';
//     } else {
...
//     // Generate JWT token
//     const token = jwt.sign(
//       { id: user.id, email: user.email, type: user.type, roles: [defaultRoleName] },
//       SECRET_KEY,
//       { expiresIn: '24h' }
//     );
